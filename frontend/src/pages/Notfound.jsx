...
export default function NotFound() {
    ...
    return (
        <div className="w-full min-h-screen bg-gray-50 font-sans text-gray-800 flex flex-col items-center justify-center relative overflow-hidden">
            <div className="container mx-auto px-4 text-center z-10 relative">
                ...
                >
                    ...
                    <h1 className="text-8xl font-extrabold text-gray-900 mb-2 font-heading tracking-tighter">
                        404
                    </h1>
