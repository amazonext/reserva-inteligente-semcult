...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      formatters={{
        // Dias da semana abreviados, primeira letra maiúscula
        formatWeekdayName: (day) => {
          const nome = day.toLocaleDateString("pt-BR", { weekday: "short" }).replace('.', '');
          return nome.charAt(0).toUpperCase() + nome.slice(1);
        },
        // Cabeçalho do mês com primeira letra maiúscula
        formatCaption: (date) => {
          const nome = date.toLocaleDateString("pt-BR", { month: "long", year: "numeric" });
          return nome.charAt(0).toUpperCase() + nome.slice(1);
        },
        // Dropdowns (quando captionLayout="dropdown")
